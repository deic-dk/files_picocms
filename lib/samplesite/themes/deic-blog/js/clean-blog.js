...
jQuery(document).ready(function($) {
  ...
  /*$.ajax({
    ...
    //Open file in file/editor view
  	$('.edit-button').click(function() {
  		...
  		var owner = $('.edit-button').attr('owner') || '';
   		...
   		window.location.href = userhomeurl+'/index.php/apps/files/?dir='+dir+'&group='+group+'&owner='+owner+'&id='+id+'&file='+encodeURIComponent(file);
  	});
    ...
    $('div#toc').first().prepend('<div id="toc_header">Contents <span id="toc_toggle">[show]</span></div>');
    $('div#toc ul').hide();
