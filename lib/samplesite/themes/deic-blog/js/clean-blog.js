    ...
    //Open file in file/editor view
  	$('.edit-button').click(function() {
  		...
  		var owner = $('.edit-button').attr('owner') || '';
   		...
   		window.location.href = userhomeurl+'/index.php/apps/files/?mime=text/markdown&dir='+dir+'&group='+group+'&owner='+owner+'&id='+id+'&file='+encodeURIComponent(file);
  	});
  ...
  <div class="imagebox">\
	...
	$('#presentation_mode').click(function(ev){
		if(!$('#presentation_mode').is(':checked')){
			$('.navbar, #show_comments, .foot, footer, header+hr.small').show();
		}
		else{
			$('.navbar, #show_comments, .foot, footer, header+hr.small').hide();
		}
